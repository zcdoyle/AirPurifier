...
void protobuf_AssignDesc_AirPurifier_2eProtoMessage_2eproto() {
  ...
  static const int ProtoMessage_Status_offsets_[9] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ProtoMessage_Status, totm_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ProtoMessage_Status, topur_),
  };
...
void protobuf_AddDesc_AirPurifier_2eProtoMessage_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "ifier\"\367\003\n\014ProtoMessage\022\r\n\005devID\030\001 \001(\004\022\014\n"
    ...
    "Message.Error\022\023\n\013messageType\030\007 \001(\r\032\207\001\n\006S"
    "tatus\022\014\n\004open\030\001 \001(\r\022\014\n\004mode\030\002 \001(\r\022\014\n\004wsp"
    "d\030\003 \001(\r\022\r\n\005click\030\004 \001(\r\022\014\n\004ermd\030\005 \001(\r\022\014\n\004"
    "time\030\006 \001(\r\022\013\n\003ver\030\007 \001(\r\022\014\n\004totm\030\010 \001(\r\022\r\n"
    "\005topur\030\t \001(\r\032L\n\006Sensor\022\014\n\004hcho\030\001 \001(\002\022\r\n\005"
    "pm2p5\030\002 \001(\002\022\023\n\013temperature\030\003 \001(\002\022\020\n\010humi"
    "dity\030\004 \001(\002\032;\n\005Error\022\013\n\003fsc\030\001 \001(\r\022\013\n\003ibc\030"
    "\002 \001(\r\022\013\n\003ibe\030\003 \001(\r\022\013\n\003uve\030\004 \001(\r\"\324\001\n\014MySQ"
    "LRequest\0228\n\ndeviceInfo\030\001 \001(\0132$.AirPurifi"
    "er.MySQLRequest.DeviceInfo\022\026\n\016serverDate"
    "Time\030\002 \001(\t\022\023\n\013messageCode\030\003 \001(\r\032]\n\nDevic"
    "eInfo\022\n\n\002id\030\001 \001(\r\022\020\n\010deviceId\030\002 \001(\004\022\030\n\020t"
    "otalPurifiedAir\030\003 \001(\002\022\027\n\017totalWordedTime"
    ...
    "AirPurifier.MySQLResponse.DeviceInfo\032]\n\n"
    "DeviceInfo\022\n\n\002id\030\001 \001(\r\022\020\n\010deviceId\030\002 \001(\004"
    "\022\030\n\020totalPurifiedAir\030\003 \001(\002\022\027\n\017totalWorde"
    "dTime\030\004 \001(\0022\233\001\n\014MySQLService\022E\n\014updateDe"
    "vice\022\031.AirPurifier.MySQLRequest\032\032.AirPur"
    "ifier.MySQLResponse\022D\n\013queryDevice\022\031.Air"
    "Purifier.MySQLRequest\032\032.AirPurifier.MySQ"
    "LResponseB\t\200\001\001\210\001\001\220\001\001", 1140);
...
const int ProtoMessage_Status::kTotmFieldNumber;
const int ProtoMessage_Status::kTopurFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 7: {
        ...
        if (input->ExpectTag(64)) goto parse_totm;
        break;
      }
      ...
      case 8: {
        ...
        if (input->ExpectTag(72)) goto parse_topur;
        break;
      }
...
void ProtoMessage_Status::SerializeWithCachedSizes(
  ...
  // optional uint32 totm = 8;
  if (has_totm()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(8, this->totm(), output);
  }

  // optional uint32 topur = 9;
  if (has_topur()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(9, this->topur(), output);
  }
...
::google::protobuf::uint8* ProtoMessage_Status::SerializeWithCachedSizesToArray(
  ...
  // optional uint32 totm = 8;
  if (has_totm()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(8, this->totm(), target);
  }

  // optional uint32 topur = 9;
  if (has_topur()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(9, this->topur(), target);
  }
...
void ProtoMessage_Status::Swap(ProtoMessage_Status* other) {
  if (other != this) {
    ...
    std::swap(totm_, other->totm_);
    std::swap(topur_, other->topur_);
...
void ProtoMessage::SerializeWithCachedSizes(
  ...
  // optional uint64 devID = 1;
  if (has_devid()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt64(1, this->devid(), output);
  }
...
::google::protobuf::uint8* ProtoMessage::SerializeWithCachedSizesToArray(
  ...
  // optional uint64 devID = 1;
  if (has_devid()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt64ToArray(1, this->devid(), target);
  }
